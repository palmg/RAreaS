    ...
    MobileArea.prototype = {
        ...
        bindEvent: function() {
            ...
            function popupArea(e) {
                ...
                _self.gearArea.className = cn("gearArea");
                _self.gearArea.innerHTML = `<div class=${cn("area_ctrl","slideInUp")}>` +
                ...
                areaCtrlInit();
                const larea_cancel = _self.gearArea.querySelector(".larea_cancel");
                larea_cancel.addEventListener('touchstart', function(e) {
                    _self.close(e);
                });
                const larea_finish = _self.gearArea.querySelector(".larea_finish");
                larea_finish.addEventListener('touchstart', function(e) {
                    _self.finish(e);
                });
                const area_province = _self.gearArea.querySelector(".area_province"),
                    area_city = _self.gearArea.querySelector(".area_city"),
                    ...
                    case 2:
                     switch(target.dataset['areatype']){
                         ...
                         _self.setGearTooth(_self.data[0]);
                             break;
                         case 'area_city':
                             const ref = target.childNodes[val].getAttribute('ref'), nextData= _self.data[2];
                             let childData=[];
        ...
        setGearTooth: function(data) {
            const _self = this,
                item = data || [],
                l = item.length,
                gearChild = _self.gearArea.querySelectorAll(".gear");
