...
var Areas = function (_React$Component) {
    ...
    function Areas() {
        ...
        _this.deepClone = _this.deepClone.bind(_this);
    ...
    _createClass(Areas, [{
        ...
        value: function submitHandle(e) {
            ...
            if (onCommit) {
                var address = this.deepClone(this.gear.data);
        ...
        key: 'deepClone',
        value: function deepClone(currobj) {
            var newobj = {};
            for (var i in currobj) {
                newobj[i] = _typeof(currobj[i]) === 'object' ? this.deepClone(currobj[i]) : currobj[i];
            }return newobj;
        }
    }, {
        key: 'render',
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(_areaGear2.default, { ref: function ref(_ref2) {
                    ...
                    }, list: this.props.list || _areaData2.default })
            );
        }
    }]);
